...
interface CustomerTableProps {
  customers: Customer[];
  onActionComplete: () => void; // Callback to refresh data after edit/delete
}
...
export function CustomerTable({ customers, onActionComplete }: CustomerTableProps) {
  return (
    <Table>
      <TableHeader>
        <TableRow>
        ...
        {customers.map((customer) => (
          <TableRow key={customer.id}>
            ...
            <TableCell className="text-right">
              <CustomerActions 
                customer={customer} 
                onCustomerDeleted={onActionComplete}
                onCustomerUpdated={onActionComplete}
              />
            </TableCell>
          </TableRow>
        ))}
